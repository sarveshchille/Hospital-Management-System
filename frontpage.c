...
void Reception(){
    ...
    do{
            ...
            printf("10.Appointment\n");
            printf("11.Add Medical Staff\n");
            printf("12.Display Medical Staffs\n");
            printf("13.Remove Medical Staff\n");
            printf("14.Inventory\n");
            printf("15.Billing and Payment\n");
            printf("16.Main menu\n");
            printf("\n\n");
            ...
            case 11 : Add_Medical_Staff();
                break;
            
            case 12 : Display_medical_staff();
                break;
            
            case 13 : Remove_medical_staff();
                break;

            case 14 : Inventory();
                break;

            case 15 : Billing_payment();
                break;
